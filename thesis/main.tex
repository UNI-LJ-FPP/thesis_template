...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LITERATURA in stil citiranja
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% *** Stil citiranja ***
%
% Pri stilu citiranja lahko izberemo med dvema možnostima
%  - numeričen: citiranje izvede preko številk v oglatih oklepajih, recimo [1]
%  - apa6: citiranje izvede z uporabo priimka avtorja in letnice, recimo Grossman, 1996

% numeričen tip citiranja
%\usepackage[backend=biber,style=numeric,sortcites]{biblatex}

% APA6 stil citiranja, kjer se oklepaji dosežejo z uporabo ukaza
%   \parencite{} namesto \cite
