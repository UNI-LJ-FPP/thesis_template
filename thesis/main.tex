...
%
%   Za izdelavo bibliografije kjer je potrebno uporabiti ukaz biber!
%
%   Potek prevajanja na svojem računalniku:
%     1. poženem xelatex main
%     2. poženem biber main
%     3. poženem 2x xelatex main
%
% ----------------------------------------------------------------------
%
...
%      potrebno je izbrati pravo SMER={splošna ali vojaška} 
%   
%  - pomstr:   pomorstvo vsš, 1. stopnja, pomorsko strojništvo
%      potrebno je izbrati pravo SMER={splošna ali vojaška}   
%   
%  - pom2:     pomorstvo, 2. stopnja, ni smeri
%
%  - promtpl:  promet uni, 1. stopnja, TPL, ni smeri
%
%  - prompttl: promet vsš, 1. stopnja, PTTL
%      potrebno je izbrati pravo SMER={splošna ali vojaška} 
%
%  - prom2:    promet, 2. stopnja, ni smeri     
% ----------------------------------------------------------------------------
%
% !!! Izberi ustrezen program in ustrezno smer, če je v programu !!!
%
% *** Pomorstvo ***
...
% *****************************************************************************
%  Dodatni potrebni paketi in nove funkcionalnosti
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ***************** Od tukaj naprej je vnos študenta **************************
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
