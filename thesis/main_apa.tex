...
\documentclass[pomnav, tisk, apa]{fppthesis}
%\documentclass[pomnav, apa]{fppthesis}
...
%
% 
% Izbira ustreznega tipa citiranja
%   pri tipu citiranja imamo dve možnosti
%     - numeric: numeričen tip, ki ga uporabljajo v naravoslovju in tehniki
%     -     apa: besedni zapis, ki ga uporabljajo v družboslovju
% 
% izbiru naredim z uporabo ustrezne besede v documentclass opcijah, spodaj sta oba primera
%  - numeričen stil: \documentclass[pomnav, numeric]{fppthesis}
%  -       apa stil: \documentclass[pomnav, apa]{fppthesis}


% *******************************************************************************
% !!! POMEMBNO: Predloga je narejena za prevajanje s pdflatex in biber ukazom !!!
% *******************************************************************************
...
\usepackage{xcolor}     % paleta dodatnih barv
\usepackage{siunitx}    % dodatno okolje za pravilno pisanje števil z enoto
\usepackage{csquotes}   % biber potrebuje
\usepackage{tabularray} % za lepo urejene tabele

% okolja za lepe tabele
\usepackage{booktabs} % za izdelavo fancy tables
...
V tem poglavju natančno opišete uporabljeno opremo in postopke dela z opremo. Mogoče v začetnem delu opišete teoretične osnovne principe, ki jih boste uporabljali. Recimo pri določanju upora ladje s pomočjo meritev modela v bazenu, se uporabi Frudejev princip, ki je bil opisan v \cite{froude1888resistance}. To je bil primer enostavnega citiranja v APA stilu.

Za APA stil citiranja, kjer bi radi uporabili oklepaje, preprosto naredite oklepaje okoli \texttt{cite} ukaza
\begin{itemize}
	\item \texttt{(\textbackslash cite\{froude1888resistance\})}: kar izvede (\cite{froude1888resistance}),
\end{itemize}
in je tako v skladu z nekaterimi navodili, ki jih imajo v družboslovju.
