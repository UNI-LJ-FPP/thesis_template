...
% literatura
\usepackage[backend=biber,sortcites,style=numeric]{biblatex}
\setcounter{biburllcpenalty}{7000}
\setcounter{biburlucpenalty}{8000}
\addbibresource{literatura.bib} % datoteka z zapisis bibliografije
...
\thispagestyle{empty}
    ...
    \begin{center}
		...
		\begin{flushleft} \large
			\emph{Avtorji:}\\[3mm]
			\hspace{1cm}\textsc{A.S.Grm} in \textsc{D.Žagar}\\[1mm]
		\end{flushleft}
...
\begin{itemize}[nosep]
	\item TexStudio (\url{htps://www.texstudio.org})
...
Spletno okolje OverLeaf je dosegljivo preko naslova \href{https://www.overleaf.com}{https://www.overleaf.com}. Tukaj se registrirate kot uporabnik in potem lahko kar pričnete z delom.
...
Kliknete na \texttt{New projekt} in ustvarite nov latex projekt. Ponudijo se vam različne možnosti, kjer je najbolje izbrati \texttt{Blank project} in uvozite predlogo FPP. Predloga za FPP \LaTeX~nalogo se nahaja na naslovu

\href{https://github.com/UNI-LJ-FPP/thesis_template/tree/main}{https://github.com/UNI-LJ-FPP/thesis\_template/tree/main} v mapi \texttt{thesis}.

Iz te mape si poberete potrebne datoteke in jih naložite v svoj OverLeaf projekt. Uvažanje je enostavno, samo kliknete na ikono za upload
...
\texttt{naloga\_ime\_priimek.tex} in pričnete lahko z delom.
...
V nadaljevanju so prikazana osnovna navodila za pisanje v \LaTeX~okolju. Zelo dobra navodila v slovenščini je prevedel Bor Plestenjak. Skripta

\href{https://github.com/UNI-LJ-FPP/thesis_template/blob/main/user_guide/Plestenjak_2006__LaTeX%20short%20navodila.pdf}{Plestenjak\_2006\_\_LaTeX short navodila.pdf}

dobite na naslovu:

\href{https://github.com/UNI-LJ-FPP/thesis_template/tree/main/user_guide}{https://github.com/UNI-LJ-FPP/thesis\_template/tree/main/user\_guide}

kjer se nahajajo tudi izvirnik za ta navodila. Izvirnik navodil se nahaja v mapi

\href{https://github.com/UNI-LJ-FPP/thesis_template/tree/main/user_guide/navodila_pisanje_naloge}{navodila\_pisanje\_naloge}
...
\begin{itemize}
	...
	\href{https://tug.ctan.org/info/lshort/english/lshort.pdf}{https://tug.ctan.org/info/lshort/english/lshort.pdf}
	...
	\item \textbf{OverLeaf} projekt z pomočjo na naslovu \href{https://www.overleaf.com/learn}{https://www.overleaf.com/learn}
	\item in še mnoga ostala literatura. 
\end{itemize}

\texttt{OverLeaf} (\href{https://www.overleaf.com}{https://www.overleaf.com} projekt omogoča urejanje latex dokumentov kar v spletni aplikaciji. Študent si naredi račun, naredi projekt, ga odpre in začne kar z delom pisanja v \LaTeX u.
...
\texttt{\textbackslash documentclass[pomstr, tisk, numeric]{fppthesis}}
...
V primeru, da bi radi dokument objavili online, izbrišete besedo \texttt{tisk} in tako se dokument prelevi v interaktivni dokument, kjer se povezave obarvajo.
...
Enostavno zbiranje virov ja preko strani \href{https://scholar.google.com}{https://scholar.google.com} (GS), kjer lahko iščete vire. Recimo zanima nas knjiga
...
Podatke označimo in jih skopiramo v datoteko. Zelo preprosto. Sedaj imamo pripravljeno podatkovno bazo naših virov. Vire lahko v OverLeaf okolju naložimo tudi iz naše osebne baze recimo Zotero ali Mandeley. Navodila, kako uvozim moje bibliografske podatke lahko najdete na naslovu

\href{https://docs.overleaf.com/integrations-and-add-ons/reference-manager-integrations}{https://docs.overleaf.com/integrations-and-add-ons/reference-manager-integrations}

\newpage
\textbf{Citiranje virov v tekstu}

Vire lahko citiramo z uporabo dveh stilov:

\begin{itemize}
	\item \emph{numeričen}: kjer potrebujemo citat vira, se v tekstu  izpiše številka v oglatih oklepajih, recimo [3]
	\item \emph{APA}: kjer potrebujemo citat vira, se v tekstu  izpiše tekst avtorja ali avtorjev, recimo Froude in Froude, 1888. Če želimo imeti okrogle oklepaje okoli, jih preprosto dodamo (Froude in Froude, 1888)
\end{itemize}

Izbiro formata citiranja določimo z izbiro v vrstici 10 datoteke, kjer pišete vašo nalogo (\texttt{main.tex}). Tukaj določimo format z ustrezno izbiro ukaza \texttt{numeric} ali \texttt{apa} v oglatih oklepajih v \texttt{documentclass} definiciji. Zgleda pa takole:

\begin{itemize}
	\item \emph{numeričen}: \texttt{\textbackslash documentclass[pomnav, tisk, numeric]\{fppthesis\}}
	\item \emph{APA}: \texttt{\textbackslash documentclass[pomnav, tisk, apa]\{fppthesis\}}
\end{itemize}

Vir sedaj citiramo z uporabo ukaza \texttt{cite}, recimo \texttt{\textbackslash cite\{molland2017ship\}}, ki bo izpisalo citat \cite{molland2017ship}. V primeru, ko želimo citirati več virov uporabimo \texttt{\textbackslash \{glob,lang,kalisnik\}}, ki bo izdelal zapis \cite{glob,lang,kalisnik}. Recimo različni primeri citiranja, ki so zapisani v datoteki naših virov \texttt{literatura.bib} in jih najdete pod njihovim ključem

\begin{itemize}
	\item citiranje zbornika: \texttt{\textbackslash cite\{zbornik\}} nam izpiše \cite{zbornik}
	\item članka z več avtorji: \texttt{\textbackslash cite\{vec-avtorjev\}} nam izpiše \cite{vec-avtorjev}
	\item internetni vir: \texttt{\textbackslash cite\{wiki\}} -- \cite{wiki} ali \texttt{\textbackslash cite\{web:lang:stats\}} -- \cite{web:lang:stats} 
\end{itemize}
