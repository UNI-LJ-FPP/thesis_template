...
% Author: A.S. Grm, D. Žagar, F. Dimc
% Description: This is an official latex ULFPP thesis template.
% Version: 1.0
% Date: 03/09/2025
% **********************************************************************

\documentclass[pomnav, tisk]{fppreport}
...
\naslov{Meritev natančnosti položaja določenega z GNSS napravo}
...
\povzetek{V dokumentu opišemo osnove za uporab \LaTeX okolja, ki ga potrebujejo študentje za izdelavo diplomske naloge in pisanje poročil pri tehničnih predmetih}

% - ključne besede, ki nastopajo v delu, ločene z vejico
\kljucnebesede{\LaTeX, diplomsko delo, poročilo, ULFPP}
...
\addbibresource{literatura.bib} % ime datoteke, ki vsebuje literaturo
